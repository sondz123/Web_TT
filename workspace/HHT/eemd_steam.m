...
xds=datastats(B);
lech=xds.std;
imf2021 = emd(B);csc=3; % chi so cot
xds_imf = datastats(imf2021(:,csc));
lech_imf=xds_imf.std;
hs_anpha=lech_imf/lech;

Nstd=hs_anpha/4; % can nang cap
E=0.01;         % gia tri nhap  
NE=round(Nstd^2/E^2);% can lam ro
