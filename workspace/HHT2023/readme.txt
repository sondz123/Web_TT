eemdExec MATLAB Python Package
...
2. Installing the eemdExec Package

A. Change to the directory that contains the file setup.py and the subdirectory eemdExec. 
...
3. Using the eemdExec Package

The eemdExec package is on your Python path. To import it into a Python script or 
session, execute:
